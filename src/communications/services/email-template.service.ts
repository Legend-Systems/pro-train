...
export class EmailTemplateService {
        ...
        try {
            ...
            const configs: TemplateConfig[] = [
                ...
                },
                {
                    ...
                    textFile: 'login-notification.txt.hbs',
                    metadata: {
                        name: 'Login Notification',
                        type: EmailType.LOGIN_NOTIFICATION,
                        version: '1.0.0',
                        ...
                        optionalData: ['deviceInfo', 'securityUrl'],
                    },
                },
                {
                ...
                },
                {
                    ...
                    htmlFile: 'test-invitation.hbs',
                    textFile: 'test-invitation.txt.hbs',
                    metadata: {
                        name: 'Test Invitation',
                        type: EmailType.TEST_INVITATION,
                        version: '1.0.0',
                        description: 'Invite users to take tests',
                        requiredData: ['testTitle', 'inviterName', 'acceptInvitationUrl'],
                        optionalData: [
                            'customMessage',
                            'expiresAt',
                            'durationMinutes',
                ...
                {
                    name: 'test-activated',
                    type: EmailType.TEST_ACTIVATED,
                    htmlFile: 'test-activated.hbs',
                    textFile: 'test-activated.txt.hbs',
                    metadata: {
                        name: 'Test Activated',
                        type: EmailType.TEST_ACTIVATED,
                        version: '1.0.0',
                        description: 'Notify users when test becomes available',
                        requiredData: ['testTitle', 'startTestUrl'],
                        optionalData: [
                            'courseTitle',
                            'testType',
                            'durationMinutes',
                ...
                {
                    name: 'test-created-notification',
                    type: EmailType.TEST_CREATED_NOTIFICATION,
                    htmlFile: 'test-created-notification.hbs',
                    textFile: 'test-created-notification.txt.hbs',
                    metadata: {
                        name: 'Test Created Notification',
                        type: EmailType.TEST_CREATED_NOTIFICATION,
                        version: '1.0.0',
                        description: 'Notify users about newly created tests',
                        requiredData: ['testTitle', 'courseTitle'],
                        optionalData: [
                            'testType',
                            'durationMinutes',
                            'maxAttempts',
    ...
    private generateSubject(templateName: string, data: TemplateData): string {
        ...
        const subjectTemplates: Record<string, string> = {
            ...
            'test-invitation': 'Test Invitation: {{testTitle}}',
            'test-activated': 'Test Now Available: {{testTitle}}',
            'test-created-notification': 'New Test Available: {{testTitle}}',
